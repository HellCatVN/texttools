    ...
    return function e(t, n, o) {
        ...
        7: [function(t, n, o) {
            ! function(r, i) {
                ...
                else if ("undefined" != typeof o) i(n, t("select"));
                else {
                    var a = {
                        exports: {}
                    };
                    ...
                    c = function() {
                        ...
                        return a(e, [{
                            ...
                            value: function() {
                                ...
                                this.fakeElem.addEventListener("focus", window.scrollTo(0, n)), this.fakeElem.style.top = n + "px", this.fakeElem.setAttribute("readonly", ""), this.fakeElem.value = this.text, document.body.appendChild(this.fakeElem), this.selectedText = (0, r.default)(this.fakeElem), this.copyText()
                            }
                        }, {
                            key: "removeFake",
                            value: function() {
        ...
        8: [function(t, n, o) {
            ! function(r, i) {
                ...
                else if ("undefined" != typeof o) i(n, t("./clipboard-action"), t("tiny-emitter"), t("good-listener"));
                else {
                    var a = {
                        exports: {}
                    };
        ...
        var t = e.document,
            ...
            h = function(t, l, u) {
                ...
                var h, v = this,
                    ...
                    w = function() {
                        if ((c || y && a) && e.FileReader) {
                            var o = new FileReader;
                            return o.onloadend = function() {
                                var t = c ? o.result : o.result.replace(/^data:[^;]*;/, "data:attachment/file;"),
                                    n = e.open(t, "_blank");
                                n || (e.location.href = t), t = void 0, v.readyState = v.DONE, m()
                            }, o.readAsDataURL(t), void(v.readyState = v.INIT)
                        }
                        if (h || (h = n().createObjectURL(t)), y) e.location.href = h;
                        else {
                            var r = e.open(h, "_blank");
                            r || (e.location.href = h)
                        }
                        v.readyState = v.DONE, m(), f(h)
                    };
                return v.readyState = v.INIT, r ? (h = n().createObjectURL(t), void setTimeout(function() {
                    o.href = h, o.download = l, i(o), m(), f(h), v.readyState = v.DONE
                })) : void w()
            },
            v = h.prototype,
            g = function(e, t, n) {
...
"undefined" != typeof module && module.exports ? module.exports.saveAs = saveAs : "undefined" != typeof define && null !== define && null !== define.amd && define("FileSaver.js", function() {
    ...
    function n(e) {
        ...
        return "/" == window.location.pathname && (n = n.replace(/\bi\b/g, "I")), n = i(n)
    }
    ...
    function r(e) {
        ...
        }), c = i(c), c = c.replace(/\(([A-Za-z])/g, function(e) {
            return e.toUpperCase()
        }), c
    }
    ...
    function l(e) {
        return e = r(e), e = e.replace(/\b(A|An|And|As|At|But|By|En|For|If|In|Of|On|Or|The|To|Vs?\\.?|Via)\b/g, function(e) {
    ...
    if (1 == $("#content").length) {
        $("#content").focus(), $("#upper").click(function() {
            return $("#content").val($("#content").val().toUpperCase()).focus(), $("#content").attr("placeholder", $("#content").attr("placeholder").toUpperCase()), s(), "function" == typeof ga && ga("send", "event", "Convert", "Upper", "", $(".word_count").text()), !1
        }), $("#lower").click(function() {
            return $("#content").val($("#content").val().toLowerCase()).focus(), $("#content").attr("placeholder", $("#content").attr("placeholder").toLowerCase()), s(), "function" == typeof ga && ga("send", "event", "Convert", "Lower", "", $(".word_count").text()), !1
        }), $("#capitalized").click(function() {
            return $("#content").val(r($("#content").val().toLowerCase())).focus(), $("#content").attr("placeholder", r($("#content").attr("placeholder"))), s(), "function" == typeof ga && ga("send", "event", "Convert", "Capitalized", "", $(".word_count").text()), !1
        }), $("#sentence").click(function() {
            return $("#content").val(n($("#content").val(), ["i"])).focus(), $("#content").attr("placeholder", n($("#content").attr("placeholder"))), s(), "function" == typeof ga && ga("send", "event", "Convert", "Sentence", "", $(".word_count").text()), !1
        }), $("#alternating").click(function() {
            return $("#content").val(o($("#content").val())).focus(), $("#content").attr("placeholder", o($("#content").attr("placeholder"))), s(), "function" == typeof ga && ga("send", "event", "Convert", "Alternating", "", $(".word_count").text()), !1
        }), $("#inverse").click(function() {
            return $("#content").val(a($("#content").val())).focus(), $("#content").attr("placeholder", a($("#content").attr("placeholder"))), s(), "function" == typeof ga && ga("send", "event", "Convert", "Inverse", "", $(".word_count").text()), !1
        }), $("#title").click(function() {
            return $("#content").val(l($("#content").val())).focus(), $("#content").attr("placeholder", l($("#content").attr("placeholder"))), s(), "function" == typeof ga && ga("send", "event", "Convert", "Title", "", $(".word_count").text()), !1
        });
        try {
            !!new Blob;
            $("#download").show().click(function() {
                if (0 == $("#content").val().length) e(no_text, "error");
                    ...
                    saveAs(n, file_name), e(downloaded, "success"), "function" == typeof ga && ga("send", "event", "Download", "Download", "", $(".word_count").text())
                }
                return !1
            })
        } catch (e) {}
        ...
        var h = new Clipboard("#copy");
        h.on("success", function(t) {
            e(copied, "success"), "function" == typeof ga && ga("send", "event", "Copied", "Copied", "", $(".word_count").text()), t.clearSelection()
        }), h.on("error", function(t) {
            e(manual_copy, "info"), "function" == typeof ga && ga("send", "event", "Copied", "Copied", "", $(".word_count").text())
        }), $(".share").on("click", function(e) {
            e.preventDefault(), windowPopup($(this).attr("href"), 520, 320)
        })
    }
    var v = "ACCEPTCONSENT";
    "y" != d(v) && ($(".cookiebar").show(), $(".cookiebar .ok").click(function(e) {
        e.preventDefault(), $(".cookiebar").slideUp(), f(v, "y", 365, "/")
    }))
});